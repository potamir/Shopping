      ...
      return (
        <div className="lIWrapper" key="lIWrapperText">
          ...
          <div className="inputWrapper">
            ...
            <p className="inputData">dec</p>
          </div>
          <div className="inputWrapper">
            <label>Country:</label>
            <p className="inputData">inD</p>
          </div>
          <div className="inputWrapper">
    ...
    if (this.state.contactEditing) {
      ...
      return (
        <div className="cIWrapper" key="cIWrapperText">
          <div className="inputWrapper">
            <label>Email:</label>
            <p className="inputData">test@Example.com</p>
          </div>
          <div className="inputWrapper">
            <label>Phone no:</label>
            <p className="inputData">997618</p>
          </div>
        </div>
      );
    }
